<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ElKing.aspx.cs" Inherits="ElKing" %>
            ...
            <div class="container clearfix">
                <div class="sixteen columns">
                    <div class="section_title clearfix">
                        <h2>Contactanos</h2>
                        <h4><span class="color">//</span>Ubicado en Pachuca Hidalgo, Blvd. Luis Donaldo Colosio, en frente de la Intermédica rumbo a Actopan</h4>
                    </div>
                    ...
                    <div class="contact_form_area clearfix">
                        ...
                        <div class="one-third column omega">
                            ...
                            <p>
                                Blvd. Luis Donaldo Colosio, Lt 5, Frente a Intermédica<br />
                                Pachuca de Soto, Hgo. C.P 42080<br />
                                México
                       
                            </p>
                            <p>
                                <strong>Teléfono:</strong> (771) 148-5444<br />
