<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Autos.aspx.cs" Inherits="Autos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div id="wrap">
        ...
        <header class="visible">
            ...
            <div id="menu">
                <ul id="nav2">
                    ...
                    <li class="external"><a href="Editar.aspx">Editar</a></li>
        ...
        <br />
        <br />
        <div style="width:90%; margin:auto; text-align:center;" class="row">
            <asp:Panel ID="PnlMenu" runat="server" Visible="false">
                <a class="btn btn-primary" href="EnviarAlertas.aspx">Enviar Correo</a>
                <a class="btn btn-primary" href="#">Clientes</a> 
                <a class="btn btn-primary" href="#">Autos</a>
        ...
        <!-- Start Table -->
        <asp:GridView ID="gvAutos" CssClass="table-hover table" Font-Size="12px"
            runat="server" AutoGenerateColumns="False"
            DataKeyNames="IdAutos,IdCliente,ClaseAuto,MarcaAuto,SubmarcaAuto,EstadoAuto,Modelo" OnRowDeleting="gvAutos_RowDeleting"
            ShowFooter="True" OnRowCancelingEdit="gvAutos_RowCancelingEdit" OnRowEditing="gvAutos_RowEditing"
            OnRowUpdating="gvAutos_RowUpdating" AllowPaging="True"
            OnPageIndexChanging="gvAutos_PageIndexChanging" ShowHeaderWhenEmpty="True">
            <Columns>
                ...
                <asp:TemplateField FooterStyle-BackColor="#373C3F" FooterStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center" HeaderText="Placa">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtPlacaEIT" Width="90px" MaxLength="7" runat="server" Text='<%# Bind("Placa") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField FooterStyle-BackColor="#373C3F" FooterStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center" HeaderText="Modelo">
                    <EditItemTemplate>
                        <asp:DropDownList ID="ddlModeloEIT" Font-Size="10px" Width="75px" runat="server" AppendDataBoundItems="true">
                    ...
                    <FooterTemplate>
                        Modelo:<br />
                        <asp:DropDownList ID="ddlModeloFT" ValidationGroup="Validar" Width="90px" runat="server" AppendDataBoundItems="True">
                            <asp:ListItem Value="-1">[Año]</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rfvTxtModeloFT" Text="**" ForeColor="Red" Display="Dynamic"
                            ValidationGroup="Validar" ControlToValidate="ddlModeloFT" InitialValue="-1" runat="server" />
                    </FooterTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
